...
public class TestBase {
	...
	public Object[][] CellreadData(String fileName, String sheetName) throws Exception {
        String[][] dataTable = null;
        ...
        for (int rowIndex=1; rowIndex<=totalRows; rowIndex++) {
            for (int cellIndex=0; cellIndex<totalCols; cellIndex++) {
            	 XSSFCell cell1 =sheet1.getRow(rowIndex).getCell(cellIndex);
            	 /*switch (cell1.getCellType()) {
                 case cell1.CELL_TYPE_STRING:
                     System.out.println(cell1.getRichStringCellValue().getString());
                     break;
                 case cell1.CELL_TYPE_NUMERIC:
